...
## 🛠️ Transformaciones y Reglas de Limpieza (Pandas)
...
## ☁️ Carga de Datos y Arquitectura Cloud (MySQL en AWS EC2)
...
Para levantar y probar el flujo de datos completo, ejecute los módulos en su terminal local en el siguiente orden estricto:

```bash
# 1. Ejecutar la fase de ingesta
python src/ingesta.py

# 2. Ejecutar la fase de limpieza y transformaciones
python src/limpieza.py

# 3. Aplicar el contrato de calidad de datos
python src/validacion.py

# 4. Cargar los datos directo en internet (AWS EC2)
python src/carga.py